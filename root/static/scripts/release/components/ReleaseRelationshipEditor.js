...
import {
  ...
  EDIT_WORK_CREATE,
} from '../../common/constants/editTypes';
...
import {uniqueNegativeId} from '../../common/utility/numbers';
import setMapDefault from '../../common/utility/setMapDefault';
import sleep from '../../common/utility/sleep';
...
} from '../../relationship-editor-v2/constants';
import type {
...
} from '../../relationship-editor-v2/utility/cloneState';
import {
  compareRecordings,
  compareWorks,
} from '../../relationship-editor-v2/utility/comparators';
import {
  compareLinkAttributeIds,
} from '../../relationship-editor-v2/utility/compareRelationships';
import {
...
import getRelationshipEditStatus
  from '../../relationship-editor-v2/utility/getRelationshipEditStatus';
import getRelationshipKey
  from '../../relationship-editor-v2/utility/getRelationshipKey';
import getRelationshipLinkType
  from '../../relationship-editor-v2/utility/getRelationshipLinkType';
import isRelationshipBackward
  from '../../relationship-editor-v2/utility/isRelationshipBackward';
import updateRecordingStates
  from '../../relationship-editor-v2/utility/updateRecordingStates';
import updateRelationships, {
  ADD_RELATIONSHIP,
  REMOVE_RELATIONSHIP,
} from '../../relationship-editor-v2/utility/updateRelationships';
import updateWorkStates
  from '../../relationship-editor-v2/utility/updateWorkStates';
import type {LoadedTracksMapT} from '../types';

import MediumRelationshipEditor from './MediumRelationshipEditor';
import {ToggleAllMediumsButtons} from './MediumToolbox';
import RelationshipEditorBatchTools from './RelationshipEditorBatchTools';
import {
...
async function submitWorkEdits(
  ...
  function getWorkEditsForEntity(
    ...
    const workTargetGroupNode = tree.find(
      targetTypeGroups,
      'work',
      compareTargetTypeWithGroup,
    );
    if (!workTargetGroupNode) {
      return;
    }
    for (
      const relationship of
      iterateRelationshipsInTargetTypeGroup(workTargetGroupNode.value)
    ) {
...
async function submitEdits(dispatch, currentStateRef) {
...
const TrackRelationshipsSection = React.memo(({
  ...
  const selectAllRecordings = React.useCallback((event) => {
    dispatch({
  ...
  const selectAllWorks = React.useCallback((event) => {
    dispatch({
      isSelected: event.target.checked,
