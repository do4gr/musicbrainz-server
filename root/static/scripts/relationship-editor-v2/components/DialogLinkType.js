...
import {PART_OF_SERIES_LINK_TYPE_IDS} from '../../common/constants';
...
export function updateDialogState(
  ...
  const oldLinkType = oldState.linkType.autocomplete.selectedEntity;
    ...
    case 'multiselect': {
      for (const valueAttribute of dialogAttribute.values) {
        ...
        children.push({
          ...
          type: valueAttribute.autocomplete.selectedEntity,
        });
      }
      break;
    }
