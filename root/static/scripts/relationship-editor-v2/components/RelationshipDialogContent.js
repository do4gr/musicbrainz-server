...
import {REL_STATUS_ADD, RelationshipSourceGroupsContext} from '../constants';
import type {
...
import DialogDatePeriod from './DialogDatePeriod';
...
import DialogTargetType from './DialogTargetType';
...
type PropsT = {
  ...
  +source: CoreEntityT,
  +sourceDispatch: (DialogAcceptActionT) => void,
...
function getOpenEditsLink(relationship) {
