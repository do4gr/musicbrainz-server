...
import type {LazyReleaseActionT} from '../../release/types';
import type {
  CreditChangeOptionT,
...
export type DialogAcceptActionT =
  | {
      ...
      +oldRelationshipState: RelationshipStateT,
...
export type DialogAcceptBatchCreateWorksActionT = {
