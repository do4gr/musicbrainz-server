...
import {compareRecordings, compareWorks} from './comparators';
import updateRecordingStates from './updateRecordingStates';
import {
  compareWorkWithWorkState,
  getWorkRecordings,
} from './updateWorkStates';
...
function* findRecordingWorks(
  ...
  const [/* 'work' */, linkTypeGroups] = targetTypeGroupNode.value;
